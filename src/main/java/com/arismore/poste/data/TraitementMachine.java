	...
	public TraitementMachine(Integer i, Document document, XPath xpath) {
		try {
			...
			this.programmeTriTitle = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:abbr[@class='programmeTri']/@title")
					.evaluate(document, XPathConstants.STRING);
			this.programmeTriId = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:abbr[@class='programmeTri']/@id")
					.evaluate(document, XPathConstants.STRING);
			...
			this.receptacleType = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='receptacle']/@type")
					.evaluate(document, XPathConstants.STRING);
			this.receptacleNiveau = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='receptacle']/@niveau")
					.evaluate(document, XPathConstants.STRING);
			this.receptacleLang = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='receptacle']/@lang")
					.evaluate(document, XPathConstants.STRING);
			...
			this.receptacleReelNiveau = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:div[@class='client']/:span[@class='receptacleReel']/@niveau")
					.evaluate(document, XPathConstants.STRING);
			this.receptacleReelTitle = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:div[@class='client']/:span[@class='receptacleReel']/@title")
					.evaluate(document, XPathConstants.STRING);
			this.receptacleReelLang = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:div[@class='client']/:span[@class='receptacleReel']/@lang")
					.evaluate(document, XPathConstants.STRING);
			this.receptacleReelTitle = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:div[@class='client']/:span[@class='receptacleReel']/@title")
			...
			this.plateformeSuivante = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='plateformeSuivante']/text()")
					.evaluate(document, XPathConstants.STRING);
			this.valeurAdressePrioritaire = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='valeur_adresse_prioritaire']/text()")
					.evaluate(document, XPathConstants.STRING);
			this.typeAdressePrioritaire = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='type_adresse_prioritaire']/text()")
					.evaluate(document, XPathConstants.STRING);
			this.cedex = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='cedex']/text()")
					.evaluate(document, XPathConstants.STRING);
			this.service = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='service']/text()")
					.evaluate(document, XPathConstants.STRING);
			this.datePublication = (String) xpath
					.compile(
							"/a:entry/a:content/:div/:ul[@class='traitement']/:li["+ i.toString()+ "]/:span[@class='datePublication']/text()")
					.evaluate(document, XPathConstants.STRING);
